...
- **Add pieces** has about 40 furniture and decor pieces at real sizes, grouped into seating, rugs and mats, tables and storage, lighting, soft decor, and plants.
...
The version menu switches between saved layouts of the room, including the starting ideas (closet reading nook, zen meditation room, cozy floor lounge, and two zones for reading and meditation). Each version has its own link (`?v=<id>`), so a specific layout can be shared directly.
